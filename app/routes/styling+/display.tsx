      ...
      <DescriptionBox>
        ...
        <SectionContainer paddingBottom={2} mb={0}>
          <BasicText color={colors.mainAccent3}>
            ...
            controlling the display property of elements, just like any other
            aspect of CSS. You can use the display prop to adjust the display
            CSS property of a component.
          </BasicText>
          <BulletBox>
            <ul>
              <li>
                <HL>Standard Display</HL>: The display prop can be set to any
                valid CSS display value
              </li>
              <li>
                <HL>Flexbox</HL>: Chakra UI has first-class support for{" "}
                <Mono>Flexbox</Mono> layouts, which is integrated directly into
                the <Mono>Box</Mono> component and also has a dedicated{" "}
                <Mono>Flex</Mono> component. Chakra UI provides props for all
                the common <Mono>Flexbox</Mono> properties, such as{" "}
                <Mono>alignItems</Mono>, <Mono>justifyContent</Mono>,{" "}
                <Mono>flexWrap</Mono>, <Mono>flexDirection</Mono>, and more.
              </li>
              <li>
                <HL>Grid</HL>: Similar to <Mono>Flexbox</Mono>, Chakra UI also
                has excellent support for <Mono>CSS Grid</Mono> layouts, with a
                dedicated <Mono>Grid</Mono> component
              </li>
              <li>
                <HL>None</HL>: You can hide elements by setting the display prop
                to <Mono>"none"</Mono>
              </li>
              <li>
                <HL>Responsive Display</HL>: As with many other props in Chakra
                UI, display can take an array or an object to specify different
      ...
      <ExampleBox paddingX={5}>
        <SectionContainer>
          <VStack spacing={4}>
            ...
            <VStack w="100%" spacing={0}>
              <BasicText>
                The following <Mono>Box</Mono> will not appear until the screen
                is at least medium size.
              </BasicText>
              <Box h={200}>
                <Box
                ...
                >
                  ...
                  screens that meet or exceed the <Mono>md</Mono> breakpoint.
                  This allows for responsive behavior where the element is
                  hidden on smaller screens and displayed as a block on larger
                  screens.
                </Box>
              </Box>
