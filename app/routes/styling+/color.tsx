      ...
      <DescriptionBox>
        ...
        <SectionContainer paddingBottom={2} mb={0}>
          ...
          <BulletBox>
            <ul>
              <li>
                <HL>Background color</HL>: You can control the background color
                of a component using the <Mono>bg</Mono> or{" "}
              ...
              <li>
                <HL>CSS colors</HL>: Colors in Chakra UI aren't just limited to
                the built-in color palette. You can use any valid CSS color
                name, a hex color code, an rgb value, etc.
              </li>
              <li>
                <HL>Responsive design</HL>: When using color props in Chakra UI,
                you can also use responsive arrays to specify different values
          ...
          <DescriptionBox>
            <BasicText>
              ...
              dark), allowing you to dynamically adjust the color of components
              based on the user's color scheme preference. This is controlled by
              the <Mono>useColorMode</Mono> hook and the{" "}
              <Mono>ColorModeProvider</Mono> component, and you can use the{" "}
              <Mono>colorScheme</Mono> prop in many components to automatically
