              ...
              <VStack spacing={4}>
                ...
                <VStack w="100%" spacing={0}>
                  ...
                  <BasicText>
                    ...
                    <Mono>rem</Mono>, <Mono>%</Mono>, and p<Mono></Mono>x. You
                    can also use string literals like <Mono>"full"</Mono> to set
                    the width to <Mono>100%</Mono>, or <Mono>"auto"</Mono> to
                    let the browser calculate the width. For responsive design,
                    you can provide an array or an object with different values
