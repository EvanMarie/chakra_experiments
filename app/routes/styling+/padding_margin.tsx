      ...
      <DescriptionBox>
        ...
        <SectionContainer paddingBottom={2} mb={0}>
          ...
          <BulletBox>
            <ul>
              <li>
                <HL>Padding</HL>: Padding is the space between the content of a
                box and its border. It's used to control the space within the
                component. In Chakra UI, you can control the padding using the{" "}
                <Mono>p</Mono>
              ...
              <li>
                ...
                different components. Similar to padding, you can control the
                margin using the <Mono>m</Mono> or <Mono>margin</Mono> props.
              </li>
            </ul>
          </BulletBox>
          <BasicText>
          ...
          <BulletBox>
            <ul>
              ...
              <li>
                ...
                <Highlighter>{`<Box p={4}>...</Box>`}</Highlighter> This will
                look up the 4th value on the spacing scale in the theme.{" "}
              </li>
              <li>
                A string value:{" "}
          ...
          <BasicText>
            Remember that the Box component in the examples can be replaced by
            any other Chakra UI component, like Button, Text, Flex, etc.,
          ...
          <VStack w="100%" spacing={6}>
            ...
            <VStack w="100%" spacing={0}>
              ...
              <BasicText>
                ...
                padding-bottom (<Mono>pb</Mono>), padding-left (<Mono>pl</Mono>
            ...
            <VStack w="100%" spacing={0}>
              ...
              <BasicText>
                ...
                <Mono>margin-left</Mono> (<Mono>ml</Mono>), and for both x-axis
                and y-axis simultaneously (<Mono>mx</Mono>, <Mono>my</Mono> ).
              </BasicText>
            </VStack>
          </VStack>{" "}
        </SectionContainer>
