      ...
      <DescriptionBox>
        ...
        <SectionContainer paddingBottom={2} mb={0}>
          ...
          <BulletBox>
            <ul>
              <li>
                <HL>Typography Components</HL>: These are covered in much more
                detail in the components-typography section, but it is important
                to note that Chakra UI provides a variety of components for
                common typographical elements, including <Mono>Heading</Mono>,{" "}
                <Mono>Text</Mono>, and <Mono>Code</Mono>.
              </li>
              <li>
                <HL>Responsive Font Sizes</HL>: Like many other props in Chakra
                UI, <Mono>fontSize</Mono> can take an array or object to specify
                different values at different breakpoints.
              </li>
              <li>
                <HL>Font Weights</HL>: Chakra UI provides props for controlling
                font weight: <Mono>fontWeight</Mono>.
              </li>
              <li>
              ...
              <li>
                <HL>Line Heights</HL>: Line height can be controlled using the
                <Mono>lineHeight</Mono> prop.
              </li>
              <li>
                <HL>Text Alignment and Decoration</HL>: Text alignment can be
                controlled with the <Mono>textAlign</Mono> prop, and{" "}
                <Mono>decoration</Mono> (like underlining) can be controlled
                with the <Mono>textDecoration</Mono> prop.
              </li>
              <li>
                <HL>Theme Customization</HL>: Chakra UI's theme object allows
                you to define default styles for typography components,
                customize the font sizes, weights, and line heights available,
                and more. You can extend the theme to include custom fonts as
                well.
              </li>
            </ul>
          </BulletBox>
