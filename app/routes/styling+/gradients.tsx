      ...
      <DescriptionBox>
        ...
        <SectionContainer paddingBottom={2} mb={0}>
          <BasicText color={colors.mainAccent3}>
            ⦾ Chakra UI supports CSS gradients right out of the box. You can use
            CSS gradient values directly, or leverage the theme's color palette
            to create consistent and beautiful gradient effects.
          </BasicText>
          <BulletBox>
            <ul>
              <li>
                <HL>Linear Gradient</HL>: You can apply linear gradients using
                standard CSS syntax.
              </li>
              <li>
          ...
          <DescriptionBox>
            <BasicText>
              When creating gradients, you can use any valid CSS color value,
              including named colors, hex codes, rgb/rgba values, and hsl/hsla
              values. However, gradients in Chakra UI have a limitation. Since
              gradient values often contain commas, they cannot be used with the
              responsive array syntax directly.
            </BasicText>
            {/* IMPORT CODE */}
            <ImportBox>
              <BasicText>
      ...
      <ExampleBox>
        <VStack>
          ...
          <VStack w="100%" spacing={0}>
            ...
            <Highlighter>{`<Box bgGradient="linear-gradient(to right, red.500, blue.500)">`}</Highlighter>
          ...
          <VStack w="100%" spacing={0}>
            ...
            <Highlighter>{`<Box bgGradient="radial-gradient(circle, red.500, blue.500)">`}</Highlighter>
...
gradients: {
  redToBlue: "linear-gradient(to right, red.500, blue.500)",
  greenToYellow: "linear-gradient(to right, green.500, yellow.500)",
},
})`}</Highlighter>
            <Highlighter>
              {`// In your component:
