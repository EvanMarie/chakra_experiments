      ...
      <DescriptionBox>
        ...
        <SectionContainer paddingBottom={2} mb={0}>
          <BasicText color={colors.mainAccent3}>
            ...
            applying CSS properties directly on Chakra UI components. Here's how
            you can set background images on Chakra UI components:
          </BasicText>
          <Box
...
>
  Content goes here
          ...
          <BasicText>
            In this example, I've used the Box component to create a div that
          ...
          <BulletBox>
            <ul>
              ...
              <li>
                ...
                "cover" ensures the background image covers the entire width and
                height of the box.
              </li>
              <li>
          ...
          <BasicText>
            It's also possible to use local images stored in your project. The
            way to do it depends on your project setup, but if you're using a
            typical React setup with Webpack, you can import the image into your
            component file and use it like so:
          </BasicText>
          <Highlighter>{`    <Box
